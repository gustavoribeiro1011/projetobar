          ...
          <div class="row">
            <div class="col-xl-12 col-lg-12">
              <form>
                ...
                <label for="">cardResumoPedido [ativo/inativo]</label>  <input type='text' class="form-control" id="inputCardResumoMesa" disabled value="<?=$_SESSION['cardresumopedido'.$app_token];?>"></input>
